package com.github.mag0716.workmanagersample.retry
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener { startOneTimeWorkUntilSuccess(3) }
    }

    private fun startOneTimeWorkUntilSuccess(retryCount: Int) {
        val work = OneTimeWorkRequestBuilder<LoggingWorker>()
                .setInputData(LoggingWorker.createInputData(TAG, retryCount))
                .build()
